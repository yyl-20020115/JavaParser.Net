...
[Serializable]
public class InstanceOfExpr : CastExpr
{
	...
	{
		string result = new StringBuilder().append("instanceof:").append(castType).append(":")
			.append(arrayDim)
			.toString();
		_ = null;
		return result;
	...
	protected InstanceOfExpr(SerializationInfo P_0, StreamingContext P_1)
		: base(P_0, P_1)
	{
	}
}
