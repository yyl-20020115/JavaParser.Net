...
[Implements(new string[] { "java.io.Serializable", "com.google.common.cache.LongAddable" })]
internal sealed class LongAdder : Striped64, Serializable.__Interface, LongAddable
{
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	[LineNumberTable(new byte[] { 18, 127, 8, 98, 223, 35, 148 })]
	...
	[LineNumberTable(new byte[] { 48, 108, 105, 99, 99, 102, 101, 19, 230, 69 })]
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	[LineNumberTable(new byte[] { 31, 106 })]
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	[LineNumberTable(new byte[] { 67, 106 })]
	...
	{
		79, 108, 105, 111, 99, 99, 104, 102, 100, 111,
		242, 60, 232, 72
	})]
	...
	[LineNumberTable(new byte[] { 160, 70, 102, 110 })]
	...
	[LineNumberTable(new byte[] { 160, 75, 102, 105, 110, 115 })]
