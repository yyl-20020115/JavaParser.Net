...
[AnnotationAttribute("org.checkerframework.framework.qual.EnsuresQualifierAttribute")]
...
[Repeatable(new object[]
{
	...
	{
		(byte)99,
		"Lorg/checkerframework/framework/qual/EnsuresQualifier+List, javaparser, Version=0/0/0/0, Culture=neutral, PublicKeyToken=null;"
	}
})]
[Implements(new string[] { "java.lang.annotation.Annotation" })]
public interface EnsuresQualifier : Annotation
{
	[InnerClass(null, Modifiers.Public | Modifiers.Static | Modifiers.Interface | Modifiers.Abstract | Modifiers.Annotation)]
	[Modifiers(Modifiers.Public | Modifiers.Interface | Modifiers.Abstract | Modifiers.Annotation)]
	[AnnotationAttribute("org.checkerframework.framework.qual.EnsuresQualifier+ListAttribute")]
	[Documented(new object[]
	{
		(byte)64,
		"Ljava/lang/annotation/Documented;"
	...
	{
		virtual EnsuresQualifier[] value();
	}

	[Modifiers(Modifiers.Final)]
	[InnerClass("org.checkerframework.framework.qual.$ProxyEnsuresQualifier$List", Modifiers.Final)]
	[Implements(new string[] { "org.checkerframework.framework.qual.EnsuresQualifier$List" })]
	...
	public sealed class ListAttribute : AnnotationAttributeBase, List
	{
		...
		private EnsuresQualifier[] value()
		{
			return (EnsuresQualifier[])getValue("value");
		}
