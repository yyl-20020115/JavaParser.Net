...
[AnnotationAttribute("org.checkerframework.framework.qual.DefaultForAttribute")]
...
public interface DefaultFor : Annotation
{
	[AnnotationDefault(new object[] { (byte)91 })]
	virtual TypeUseLocation[] value();
	...
	[AnnotationDefault(new object[] { (byte)91 })]
	virtual string[] namesExceptions();
}
