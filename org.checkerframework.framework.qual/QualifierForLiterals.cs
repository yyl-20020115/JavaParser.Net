...
[AnnotationAttribute("org.checkerframework.framework.qual.QualifierForLiteralsAttribute")]
...
public interface QualifierForLiterals : Annotation
{
	[AnnotationDefault(new object[] { (byte)91 })]
	virtual LiteralKind[] value();

	[AnnotationDefault(new object[] { (byte)91 })]
	virtual string[] stringPatterns();
}
