...
public class NoCommentHashCodeVisitorGenerator : VisitorGenerator
{
	...
	public NoCommentHashCodeVisitorGenerator(SourceRoot sourceRoot)
		: base(sourceRoot, "com.github.javaparser.ast.visitor", "NoCommentHashCodeVisitor", "Integer", "Void", createMissingVisitMethods: true)
	{
	}
	...
	{
		159, 189, 149, 113, 139, 117, 103, 115, 109, 111,
		159, 12, 127, 3, 127, 3, 115, 105, 127, 7,
		229, 69, 113, 105, 159, 22, 191, 17, 105, 110,
		127, 17, 110, 159, 14, 191, 12, 133, 114
	})]
	protected internal override void generateVisitMethodBody(BaseNodeMetaModel node, MethodDeclaration visitMethod, CompilationUnit compilationUnit)
	{
		...
		if (node.equals(JavaParserMetaModel.___003C_003ElineCommentMetaModel) || node.equals(JavaParserMetaModel.___003C_003EblockCommentMetaModel) || node.equals(JavaParserMetaModel.___003C_003EjavadocCommentMetaModel) || allPropertyMetaModels.isEmpty())
		{
