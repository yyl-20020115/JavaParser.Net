...
public class ObjectIdentityHashCodeVisitorGenerator : VisitorGenerator
{
	...
	public ObjectIdentityHashCodeVisitorGenerator(SourceRoot sourceRoot)
		: base(sourceRoot, "com.github.javaparser.ast.visitor", "ObjectIdentityHashCodeVisitor", "Integer", "Void", createMissingVisitMethods: true)
	{
	}
	...
	protected internal override void generateVisitMethodBody(BaseNodeMetaModel node, MethodDeclaration visitMethod, CompilationUnit compilationUnit)
	{
		...
		blockStmt.addStatement("return n.GetHashCode();");
	}
}
