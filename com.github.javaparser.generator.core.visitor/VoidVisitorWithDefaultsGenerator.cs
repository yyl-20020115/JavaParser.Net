...
public class VoidVisitorWithDefaultsGenerator : VisitorGenerator
{
	...
	public VoidVisitorWithDefaultsGenerator(SourceRoot sourceRoot)
		: base(sourceRoot, "com.github.javaparser.ast.visitor", "VoidVisitorWithDefaults", "void", "A", createMissingVisitMethods: true)
	{
	}
	...
	protected internal override void generateVisitMethodBody(BaseNodeMetaModel node, MethodDeclaration visitMethod, CompilationUnit compilationUnit)
	{
		...
		blockStmt.addStatement("defaultAction(n, arg);");
	}
}
