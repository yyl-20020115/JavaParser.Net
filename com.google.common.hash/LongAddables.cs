...
internal sealed class LongAddables : java.lang.Object
{
	...
	[Signature("Ljava/lang/Object;Lcom/google/common/base/Supplier<Lcom/google/common/hash/LongAddable;>;")]
	...
	[Implements(new string[] { "com.google.common.hash.LongAddable" })]
	internal sealed class PureJavaLongAddable : AtomicLong, LongAddable
	{
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		[LineNumberTable(new byte[] { 10, 103 })]
	...
	[Signature("Lcom/google/common/base/Supplier<Lcom/google/common/hash/LongAddable;>;")]
	...
	{
		159, 175, 102, 247, 79, 226, 56, 97, 230, 72,
		121
	})]
	static LongAddables()
	{
