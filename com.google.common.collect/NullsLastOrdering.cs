...
internal sealed class NullsLastOrdering : Ordering, Serializable.__Interface, ISerializable
{
	...
	internal NullsLastOrdering(Ordering P_0)
	{
		ordering = P_0;
	}
	...
	{
		Ordering result = ordering.reverse().nullsFirst();
		_ = null;
		return result;
	}
	...
	{
		Ordering result = ordering.nullsFirst();
		_ = null;
		return result;
	}
	...
	})] object P_0)
	{
		...
		if (P_0 is NullsLastOrdering)
		{
			NullsLastOrdering nullsLastOrdering = (NullsLastOrdering)P_0;
			bool result = java.lang.Object.instancehelper_equals(ordering, nullsLastOrdering.ordering);
			_ = null;
			return result;
		}
		return false;
	...
	{
		return java.lang.Object.instancehelper_hashCode(ordering) ^ -921210296;
	}
	...
	public override string toString()
	{
		...
		int num = 12 + java.lang.String.instancehelper_length(java.lang.String.valueOf(text));
		num = num;
		string result = new StringBuilder(num).append(text).append(".nullsLast()").toString();
		_ = null;
		return result;
	}
	...
	[HideFromJava]
	[PermissionSet(SecurityAction.Demand, XML = "<PermissionSet class=\"System.Security.PermissionSet\"\r\nversion=\"1\">\r\n<IPermission class=\"System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089\"\r\nversion=\"1\"\r\nFlags=\"SerializationFormatter\"/>\r\n</PermissionSet>\r\n")]
	protected NullsLastOrdering(SerializationInfo P_0, StreamingContext P_1)
	{
