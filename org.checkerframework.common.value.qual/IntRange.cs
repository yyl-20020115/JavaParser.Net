...
[AnnotationAttribute("org.checkerframework.common.value.qual.IntRangeAttribute")]
...
public interface IntRange : Annotation
{
	[AnnotationDefault(long.MinValue)]
	virtual long from();

	[AnnotationDefault(long.MaxValue)]
	virtual long to();
}
