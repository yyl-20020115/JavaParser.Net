...
[AnnotationAttribute("org.checkerframework.common.value.qual.EnsuresMinLenIfAttribute")]
...
[ConditionalPostconditionAnnotation(new object[]
{
	...
	{
		(byte)99,
		"Lorg/checkerframework/common/value/qual/MinLen, javaparser, Version=0/0/0/0, Culture=neutral, PublicKeyToken=null;"
	}
})]
...
[Repeatable(new object[]
{
	...
	{
		(byte)99,
		"Lorg/checkerframework/common/value/qual/EnsuresMinLenIf+List, javaparser, Version=0/0/0/0, Culture=neutral, PublicKeyToken=null;"
	}
})]
[Implements(new string[] { "java.lang.annotation.Annotation" })]
public interface EnsuresMinLenIf : Annotation
{
	[InnerClass(null, Modifiers.Public | Modifiers.Static | Modifiers.Interface | Modifiers.Abstract | Modifiers.Annotation)]
	[Modifiers(Modifiers.Public | Modifiers.Interface | Modifiers.Abstract | Modifiers.Annotation)]
	[AnnotationAttribute("org.checkerframework.common.value.qual.EnsuresMinLenIf+ListAttribute")]
	[Documented(new object[]
	{
		(byte)64,
		"Ljava/lang/annotation/Documented;"
	...
	{
		virtual EnsuresMinLenIf[] value();
	}

	[Modifiers(Modifiers.Final)]
	[InnerClass("org.checkerframework.common.value.qual.$ProxyEnsuresMinLenIf$List", Modifiers.Final)]
	[Implements(new string[] { "org.checkerframework.common.value.qual.EnsuresMinLenIf$List" })]
	...
	public sealed class ListAttribute : AnnotationAttributeBase, List
	{
		...
		private EnsuresMinLenIf[] value()
		{
			return (EnsuresMinLenIf[])getValue("value");
		}

		EnsuresMinLenIf[] List.value()
		{
