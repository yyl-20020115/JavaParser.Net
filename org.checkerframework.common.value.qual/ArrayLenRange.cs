...
[AnnotationAttribute("org.checkerframework.common.value.qual.ArrayLenRangeAttribute")]
...
public interface ArrayLenRange : Annotation
{
	[AnnotationDefault(0)]
	virtual int from();

	[AnnotationDefault(int.MaxValue)]
	virtual int to();
}
