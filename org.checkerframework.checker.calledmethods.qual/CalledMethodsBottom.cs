...
[AnnotationAttribute("org.checkerframework.checker.calledmethods.qual.CalledMethodsBottomAttribute")]
[SubtypeOf(new object[]
{
	...
	new object[]
	{
		...
		{
			(byte)99,
			"Lorg/checkerframework/checker/calledmethods/qual/CalledMethodsPredicate, javaparser, Version=0/0/0/0, Culture=neutral, PublicKeyToken=null;"
		}
	}
})]
...
public interface CalledMethodsBottom : Annotation
{
}
