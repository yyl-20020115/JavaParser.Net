...
[AnnotationAttribute("org.checkerframework.checker.nullness.qual.MonotonicNonNullAttribute")]
...
[SubtypeOf(new object[]
{
	...
	new object[]
	{
		...
		{
			(byte)99,
			"Lorg/checkerframework/checker/nullness/qual/Nullable, javaparser, Version=0/0/0/0, Culture=neutral, PublicKeyToken=null;"
		}
	}
})]
[MonotonicQualifier(new object[]
{
	(byte)64,
	"Lorg/checkerframework/framework/qual/MonotonicQualifier;",
	"value",
	new object[]
	{
		(byte)99,
...
public interface MonotonicNonNull : Annotation
{
}
