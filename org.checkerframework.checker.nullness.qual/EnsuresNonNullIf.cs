...
[AnnotationAttribute("org.checkerframework.checker.nullness.qual.EnsuresNonNullIfAttribute")]
...
[Repeatable(new object[]
{
	...
	{
		(byte)99,
		"Lorg/checkerframework/checker/nullness/qual/EnsuresNonNullIf+List, javaparser, Version=0/0/0/0, Culture=neutral, PublicKeyToken=null;"
	}
})]
[Implements(new string[] { "java.lang.annotation.Annotation" })]
public interface EnsuresNonNullIf : Annotation
{
	[InnerClass(null, Modifiers.Public | Modifiers.Static | Modifiers.Interface | Modifiers.Abstract | Modifiers.Annotation)]
	[Modifiers(Modifiers.Public | Modifiers.Interface | Modifiers.Abstract | Modifiers.Annotation)]
	[AnnotationAttribute("org.checkerframework.checker.nullness.qual.EnsuresNonNullIf+ListAttribute")]
	[Documented(new object[]
	{
		(byte)64,
		"Ljava/lang/annotation/Documented;"
	...
	{
		virtual EnsuresNonNullIf[] value();
	}

	[Modifiers(Modifiers.Final)]
	[InnerClass("org.checkerframework.checker.nullness.qual.$ProxyEnsuresNonNullIf$List", Modifiers.Final)]
	[Implements(new string[] { "org.checkerframework.checker.nullness.qual.EnsuresNonNullIf$List" })]
	...
	public sealed class ListAttribute : AnnotationAttributeBase, List
	{
		...
		private EnsuresNonNullIf[] value()
		{
			return (EnsuresNonNullIf[])getValue("value");
		}

		EnsuresNonNullIf[] List.value()
		{
