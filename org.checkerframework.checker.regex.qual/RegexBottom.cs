...
[AnnotationAttribute("org.checkerframework.checker.regex.qual.RegexBottomAttribute")]
...
[SubtypeOf(new object[]
{
	...
	new object[]
	{
		...
		{
			(byte)99,
			"Lorg/checkerframework/checker/regex/qual/Regex, javaparser, Version=0/0/0/0, Culture=neutral, PublicKeyToken=null;"
		},
		new object[]
		{
			(byte)99,
			"Lorg/checkerframework/checker/regex/qual/PartialRegex, javaparser, Version=0/0/0/0, Culture=neutral, PublicKeyToken=null;"
		}
	}
})]
...
public interface RegexBottom : Annotation
{
}
