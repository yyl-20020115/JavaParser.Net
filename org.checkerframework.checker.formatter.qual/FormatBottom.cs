...
[AnnotationAttribute("org.checkerframework.checker.formatter.qual.FormatBottomAttribute")]
...
[SubtypeOf(new object[]
{
	...
	new object[]
	{
		...
		{
			(byte)99,
			"Lorg/checkerframework/checker/formatter/qual/Format, javaparser, Version=0/0/0/0, Culture=neutral, PublicKeyToken=null;"
		},
		new object[]
		{
			(byte)99,
			"Lorg/checkerframework/checker/formatter/qual/InvalidFormat, javaparser, Version=0/0/0/0, Culture=neutral, PublicKeyToken=null;"
		}
	}
})]
...
public interface FormatBottom : Annotation
{
}
