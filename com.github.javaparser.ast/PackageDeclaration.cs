...
public class PackageDeclaration : Node, NodeWithAnnotations, NodeWithName
{
	...
	public virtual PackageDeclaration setAnnotations(NodeList annotations)
	{
	...
	public virtual PackageDeclaration setName(Name name)
	{
	...
	public new virtual PackageDeclarationMetaModel getMetaModel()
	{
		return JavaParserMetaModel.___003C_003EpackageDeclarationMetaModel;
	}

	
	
	public new virtual PackageDeclaration clone()
	{
	...
	{
		PackageDeclarationMetaModel metaModel = getMetaModel();
	...
	{
		PackageDeclaration result = clone();
	...
	{
		PackageDeclaration result = setAnnotations(annotations);
	...
	{
		PackageDeclaration result = setName(name);
