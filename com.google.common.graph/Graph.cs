...
[DoNotMock(new object[]
{
	...
	"value",
	"Use GraphBuilder to create a real instance"
})]
...
public interface Graph : BaseGraph, SuccessorsFunction, PredecessorsFunction
{
	[HideFromJava]
	public new static class __DefaultMethods
	{
		public unsafe static Iterable successors(Graph P_0, object P_1)
		{
			__ldvirtftn(object.ToString);
			return _003Cdefault_003E_003Cbridge_003Esuccessors(P_0, P_1);
		}

		public unsafe static Iterable predecessors(Graph P_0, object P_1)
		{
			__ldvirtftn(object.ToString);
	...
	[SpecialName]
	[LineNumberTable(104)]
	static Iterable _003Cdefault_003E_003Cbridge_003Esuccessors(Graph P_0, object P_1)
	{
	...
	[SpecialName]
	[LineNumberTable(104)]
	static Iterable _003Cdefault_003E_003Cbridge_003Epredecessors(Graph P_0, object P_1)
	{
